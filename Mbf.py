...
{B}╠╣ {W}├─┤│  ├┤ ├┴┐│ ││ │├┴┐{R}───{B}║║║{W}├┴┐├┤ 
{B}╚  {W}┴ ┴└─┘└─┘└─┘└─┘└─┘┴ ┴   {B}╩ ╩{W}└─┘└  ''')
    print('' + Back.BLUE + Fore.BLACK + '        Creator : NicoID         \033[00m')
    print()
       ...
       with ThreadPoolExecutor(max_workers=30) as ex:
            for user in username:
                ...
                for x in bb:
                    ...
                    litpas.append('januari')
                    litpas.append('pebuari')
                    litpas.append('maret')
                    litpas.append('april')
                    litpas.append('mei')
                    litpas.append('juni')
                    litpas.append('juli')
                    litpas.append('agustus')
                    litpas.append('september')
                    litpas.append('oktober')
                    litpas.append('november')
                    litpas.append('desember')
                    litpas.append('ngentot')
                    litpas.append('1990')
                    litpas.append('1991')
                    litpas.append('1992')
                    litpas.append('1993')
